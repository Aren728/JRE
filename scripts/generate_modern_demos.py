...
def _build_case_study_md(
    ...
    lines.append("---")
    lines.append("")
    lines.append("*Generated by JRE v1.0.0 — Model frozen. No reasoning logic changes.*")
...
def _generate_readme(output_dir: Path, generated_files: list[str], fixture_files: list[Path]) -> None:
    ...
    lines.append("")
    lines.append("**Phase G Demo Package** — Generated by the Jyotish Reasoning Engine (JRE) v1.0.0")
    lines.append("")
    ...
    lines.append(f"- **Engine Version:** v1.0.0 (frozen)")
    ...
    lines.append("")
    lines.append("---")
    lines.append("*Generated by JRE v1.0.0 — Model frozen at v1.0.0.*")
