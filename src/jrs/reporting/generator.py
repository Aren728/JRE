...
class ReportGenerator:
    ...
    def _get_yoga_description(self, yoga_name: str) -> str:
        ...
        return _YOGA_DESCRIPTIONS.get(yoga_name, f"{yoga_name} yoga detected in the chart.")
    ...
    def generate_markdown(self) -> str:
        ...
        lines.append(f"**Yogas Detected:** {r.yoga_count} ({r.formed_count} active)")
        if r.engine_version:
        ...
        lines.append("")
        lines.append(
            "This report is generated by the Jyotish Reasoning Engine (JRE), "
        ...
        lines.append("")
        lines.append(
            "Yoga detection follows classical conditions exactly as described "
