"""Transitions domain data models — outcome taxonomy, rule catalog, fact evaluation."""
...
class TransitionOutcomeTaxonomy(Enum):
    """Highly specific major life transition outcome taxonomies."""

    LIFE_PHASE_SHIFT = "LIFE_PHASE_SHIFT"
    SUDDEN_UPHEAVAL = "SUDDEN_UPHEAVAL"
...
class TransitionRule:
    """A single classical rule mapping JRE facts to a transition outcome."""
...
@dataclass(frozen=True)
class TransitionRuleCatalog:
    """Complete catalog of transitions domain rules."""
    ...
    def get_rule_by_id(self, rule_id: str) -> TransitionRule | None:
...
class TransitionConfig:
    """Configuration for the transitions domain."""
...
def evaluate_rule(
    ...
    Args:
        rule: The transition rule to evaluate.
...
def evaluate_facts(
    ...
    Args:
        rules: The tuple of transition rules to evaluate.
        facts: The facts dictionary from JRE engines.
