"""Property domain data models — outcome taxonomy, rule catalog, fact evaluation."""
...
class PropertyOutcomeTaxonomy(Enum):
    """Highly specific property/residence outcome taxonomies."""

    PROPERTY_ACQUISITION = "PROPERTY_ACQUISITION"
    REAL_ESTATE_WEALTH = "REAL_ESTATE_WEALTH"
    DISPUTES_OVER_PROPERTY = "DISPUTES_OVER_PROPERTY"
...
class PropertyRule:
    """A single classical rule mapping JRE facts to a property outcome."""
...
class PropertyRuleCatalog:
    """Complete catalog of property domain rules."""

    rules: tuple[PropertyRule, ...] = ()
    ...
    def get_rule_by_id(self, rule_id: str) -> PropertyRule | None:
...
class PropertyConfig:
    """Configuration for the property domain."""
...
def evaluate_rule(
    ...
    Args:
        rule: The property rule to evaluate.
...
def evaluate_facts(
    ...
    Args:
        rules: The tuple of property rules to evaluate.
        facts: The facts dictionary from JRE engines.
