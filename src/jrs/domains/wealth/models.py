"""Wealth domain data models — outcome taxonomy, rule catalog, fact evaluation."""
...
class WealthOutcomeTaxonomy(Enum):
    """Highly specific wealth/finance outcome taxonomies."""

    WEALTH_ACCUMULATION = "WEALTH_ACCUMULATION"
    SUDDEN_FINANCIAL_LOSS = "SUDDEN_FINANCIAL_LOSS"
    INHERITANCE = "INHERITANCE"
    DEBT_BURDEN = "DEBT_BURDEN"
    MULTIPLE_INCOME_STREAMS = "MULTIPLE_INCOME_STREAMS"
    WEALTH_THROUGH_SPOUSE = "WEALTH_THROUGH_SPOUSE"
    CHARITABLE_DISPOSITION = "CHARITABLE_DISPOSITION"
    FINANCIAL_STABILITY = "FINANCIAL_STABILITY"
    SPECULATIVE_GAINS = "SPECULATIVE_GAINS"
    PROPERTY_WEALTH = "PROPERTY_WEALTH"
    BUSINESS_WEALTH = "BUSINESS_WEALTH"
    EARNING_DIFFICULTY = "EARNING_DIFFICULTY"
    FINANCIAL_RECOVERY = "FINANCIAL_RECOVERY"
    UNEXPECTED_WINDFALL = "UNEXPECTED_WINDFALL"
...
class WealthRule:
    """A single classical rule mapping JRE facts to a wealth outcome."""
...
@dataclass(frozen=True)
class WealthRuleCatalog:
    """Complete catalog of wealth domain rules."""

    rules: tuple[WealthRule, ...] = ()
    ...
    def get_rule_by_id(self, rule_id: str) -> WealthRule | None:
...
@dataclass(frozen=True)
class WealthConfig:
    """Configuration for the wealth domain."""
...
def evaluate_rule(
    ...
    Args:
        rule: The wealth rule to evaluate.
...
def evaluate_facts(
    ...
    Args:
        rules: The tuple of wealth rules to evaluate.
        facts: The facts dictionary from JRE engines.
