"""Education domain data models — outcome taxonomy, rule catalog, fact evaluation."""
...
class EducationOutcomeTaxonomy(Enum):
    """Highly specific education outcome taxonomies."""

    HIGHER_EDUCATION = "HIGHER_EDUCATION"
    EARLY_EDUCATION_SUCCESS = "EARLY_EDUCATION_SUCCESS"
    EDUCATION_DISRUPTION = "EDUCATION_DISRUPTION"
...
class EducationRule:
    """A single classical rule mapping JRE facts to an education outcome."""
...
@dataclass(frozen=True)
class EducationRuleCatalog:
    """Complete catalog of education domain rules."""

    rules: tuple[EducationRule, ...] = ()
    ...
    def get_rule_by_id(self, rule_id: str) -> EducationRule | None:
...
class EducationConfig:
    """Configuration for the education domain."""
...
def evaluate_rule(
    ...
    Args:
        rule: The education rule to evaluate.
...
def evaluate_facts(
    ...
    Args:
        rules: The tuple of education rules to evaluate.
        facts: The facts dictionary from JRE engines.
