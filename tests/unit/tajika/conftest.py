"""Shared builders for JRE-017 Tajika unit tests."""
...
@pytest.fixture
def natal_moon_in_aries() -> RashiId:
    """Natal Moon in Aries."""
    return RashiId.MESHA


@pytest.fixture
def natal_moon_in_taurus() -> RashiId:
    """Natal Moon in Taurus."""
    return RashiId.VRISHABHA


@pytest.fixture
def solar_return_planets() -> tuple[PlanetState, ...]:
    """Sample solar return chart planets."""
    return (
        make_sun_state(10.0),
